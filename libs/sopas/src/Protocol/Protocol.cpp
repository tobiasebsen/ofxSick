 ...
 */
/*======================================================================================*/
void CProtocol::PollAsyncAnswers(int iPollTimeMs, CCommunicationHandler::SopasAsyncCallback pCallback)
{
  m_pCommHandler->PollAsyncAnswers(iPollTimeMs, pCallback);
}
 ...
 */
/*======================================================================================*/
void CProtocol::SetAsyncCallback(CCommunicationHandler::SopasAsyncCallback pCallback)
{
