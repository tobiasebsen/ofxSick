...
{
public:
  typedef void (*SopasAsyncCallback)(const SDecodedAnswer&, CBinaryDataStream&, CDeserializer&);
  ...
  void PollAsyncAnswers(int iPollTimeMs, SopasAsyncCallback pCallback);
    //!< Poll for asynchronous events or device method answers.
  void SetAsyncCallback(SopasAsyncCallback pCallback);
...
private:
  ...
  void HandleAsyncAnswer(std::auto_ptr<CBinaryDataStream>& rAnswer, SopasAsyncCallback pTemporaryCallback);
