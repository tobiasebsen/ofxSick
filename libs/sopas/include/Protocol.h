...
public:
  ...
  void PollAsyncAnswers(int iPollTimeMs, CCommunicationHandler::SopasAsyncCallback pCallback = 0);
    //!< Poll for asynchronous events or device method answers.
  void SetAsyncCallback(CCommunicationHandler::SopasAsyncCallback pCallback);
